              ...
              PieChartData(
                ...
                sections: List.generate(top.length, (i) {
                  ...
                  return PieChartSectionData(
                    ...
                    titleStyle: const TextStyle(fontWeight: FontWeight.w900, fontSize: 13.5, color: Colors.white),
                  );
                }),
              ),
            ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          ...
                          style: TextStyle(color: Palette.ink.withValues(alpha: 0.8), fontWeight: FontWeight.w800, fontSize: 13.5),
                        ),
                      ),
                      const SizedBox(width: 6),
                      Text(
                        e.value.toString(),
                        style: const TextStyle(color: Palette.ink, fontWeight: FontWeight.w900, fontSize: 13.5),
                      ),
                    ],
                  ),
                );

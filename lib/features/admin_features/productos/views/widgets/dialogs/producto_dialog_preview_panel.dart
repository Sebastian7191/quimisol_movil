...
import 'package:quimisol_movil/features/admin_features/productos/views/widgets/dialogs/promo_banner_preview.dart';
import 'package:quimisol_movil/features/admin_features/productos/views/widgets/producto_card_preview.dart';
        ...
        builder: (context, constraints) {
          ...
          Widget previewBody = ValueListenableBuilder<int>(
            ...
            builder: (_, __, ___) {
              ...
              String? discountText;
              if (hasDiscount) {
                final val = controller.parseDouble(
                  controller.descuentoCtrl.text,
                );
              ...
              final phone = SizedBox(
                ...
                child: PhonePreviewFrame(
                  ...
                  child: LayoutBuilder(
                    builder: (context, c) {
                      final double cardW = (c.maxWidth * 0.92).clamp(
                        195.0,
                        240.0,
                      );
          ...
          if (!hasBoundedHeight) {
            previewBody = SizedBox(height: 560, child: previewBody);
          } else {

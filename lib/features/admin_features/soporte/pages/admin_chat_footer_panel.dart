...
import 'package:quimisol_movil/features/admin_features/soporte/pages/admin_chat_page.dart';
                  ...
                  builder: (context, _) {
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                            color: Colors.black.withValues(alpha: shadowOpacity.value),
                            blurRadius: 24,
                      ...
                      ? TweenAnimationBuilder<double>(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                color: Palette.button.withValues(alpha: 0.20),
                              ),
                              boxShadow: [
                                BoxShadow(
                  ...
                  child: InkWell(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                            color: Colors.black.withValues(alpha: _open ? 0.22 : 0.16),
            ...
            Container(
              ...
              child: Row(
                children: [
                  CircleAvatar(
                    radius: 20,
                    backgroundColor: Palette.button.withValues(alpha: 0.14),
                    child: const Icon(
                      Icons.support_agent_rounded,
                      color: Palette.primary,
                      size: 22,
